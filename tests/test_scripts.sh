...
assert_contains "$ROOT/setup-clash-subscription.sh" 'default_url=http://caddy:8080/source.txt'
assert_contains "$ROOT/setup-clash-subscription.sh" 'docker port subscription-caddy 8080/tcp'
